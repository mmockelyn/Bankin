...
<div class="d-flex flex-column flex-root">
    ...
    <div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(/assets/media/illustrations/sketchy-1/14.png">
        ...
        <div class="stepper stepper-pills" id="kt_stepper_example_basic">
            ...
            <!--begin::Form-->
            <form class="form w-lg-1000px mx-auto card" novalidate="novalidate" id="kt_stepper_example_basic_form">
                    ...
                    <div class="scroll mb-5">
                        ...
                        <div class="flex-column" data-kt-stepper-element="content">
                            ...
                            <div class="btn-group w-100 w-lg-50 mb-10" data-kt-buttons="true" data-kt-buttons-target="[data-kt-button]">
                                ...
                                <label class="btn btn-outline-secondary text-muted text-hover-white text-active-white btn-outline btn-active-success" data-kt-button="true">
                                    <!--begin::Input-->
                                    <input class="btn-check" type="radio" name="pro_activity" value="true"/>
                                    <!--end::Input-->
                                    Oui
                                </label>
                                <!--end::Radio-->
                                ...
                                <label class="btn btn-outline-secondary text-muted text-hover-white text-active-white btn-outline btn-active-success" data-kt-button="true">
                                    <!--begin::Input-->
                                    <input class="btn-check" type="radio" name="pro_activity" value="false"/>
                                    <!--end::Input-->
                                    Non
                                </label>
                                <!--end::Radio-->
                            ...
                            <div class="mb-10 w-500px">
                                ...
                                <select class="form-control form-select" data-control="select2" name="activity_domain">
                                    <option value=""></option>
                                    <option value="France">Cadre</option>
                                    <option value="France">Employé de commerce</option>
                                    <option value="France">Employé administratif</option>
                                    <option value="France">Gérant, Président, assimilé,etc...</option>
                                </select>
                            </div>
                        ...
                        <div class="flex-column" data-kt-stepper-element="content">
                            ...
                            <div class="row g-10">
                                <div class="col-xl-6">
                                    <input type="radio" class="btn-check" name="plan" value="silver" checked="checked"  id="kt_radio_buttons_2_option_1"/>
                                ...
                                <div class="col-xl-6">
                                    <input type="radio" class="btn-check" name="plan" value="gold" checked="checked"  id="kt_radio_buttons_2_option_2"/>
                        ...
                        <div class="flex-column" data-kt-stepper-element="content">
                            ...
                            <x-form.input
                                ...
                                type="text"
                                label="Adresse"
                                value="22 Rue Maryse Bastié, 85100 Les Sables d'Olonne, France"
                                readonly
                                class="is-valid" />
                            ...
                            <h3 class="fw-bold mb-5">Votre Carte</h3>
                            <div class="d-flex align-items-sm-center mb-7">
                                <!--begin::Symbol-->
                                <div class="symbol symbol-100px symbol-2by3 me-4">
                                    <div class="symbol-label" style="background-image: url('/storage/card_gold.png')"></div>
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Title-->
                                <div class="d-flex flex-row-fluid flex-wrap align-items-center">
                                    <div class="flex-grow-1 me-2">
                                        <a href="#" class="text-gray-800 fw-bolder text-hover-primary fs-6">Carte {{ config('app.name') }} Gold avec assurance & assistance incluse</a>
                                        <span class="text-muted fw-bold d-block pt-1">Fourniture d'une carte de débit (Carte de paiement Internationnal à débit différé)</span>
                                    </div>
                                </div>
                                <!--end::Title-->
                            </div>
                            ...
                            <h3 class="fw-bold mb-5">Votre Facilité de caisse</h3>
                            <p>
                                ...
                                Montant maximal autorisé: 300 euros sur 15 jours par période de 30 jours.<br>
                                Taux nominal conventionnel: 9,98% / TAEG: 21,07%<br>
