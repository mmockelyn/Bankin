    ...
    <div class="container-xxl d-flex flex-grow-1 flex-stack">
        ...
        <div class="d-flex align-items-center me-5">
            ...
            <a href="../../demo16/dist/index.html">
                <img alt="Logo" src="/storage/logo.png" class="h-25px h-lg-30px" />
            </a>
            <!--end::Logo-->
            <!--begin::Nav-->
            <div class="ms-5 ms-md-10 me-3">
                ...
                <button type="button" class="btn btn-nav btn-outline btn-flex btn-active-color-white align-items-center justify-content-center justify-content-md-between align-items-lg-cenrer flex-md-content-between btn-color-gray-500 px-0 ps-md-5 pe-md-4 h-30px w-30px h-md-35px w-md-175px" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start">
                    <span class="fs-7 d-none d-md-inline">Espaces</span>
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg fw-bold w-200px pb-3" data-kt-menu="true">
                    ...
                    <div class="menu-item px-3">
                        <div class="menu-content fs-7 text-dark fw-bolder px-3 py-4">Selectionnez votre espaces:</div>
                    </div>
                    <!--end::Menu item-->
                    ...
                    <!--begin::Menu item-->
                    <div class="menu-item px-3">
                        <a href="{{ route('account.dashboard') }}" class="menu-link px-3">Compte</a>
                    </div>
                    <!--end::Menu item-->
                    <!--begin::Menu item-->
                    <div class="menu-item px-3">
                    ...
                    <!--begin::Menu item-->
                    <div class="menu-item px-3">
                        <a href="#" class="menu-link px-3">Moyens de paiement</a>
                    </div>
                    <!--end::Menu item-->
                    <!--begin::Menu item-->
                    <div class="menu-item px-3">
                        <a href="#" class="menu-link px-3">Assurances</a>
                    </div>
                    <!--end::Menu item-->
                    <!--begin::Menu item-->
                    <div class="menu-item px-3">
                        <a href="#" class="menu-link px-3">Documents</a>
                    </div>
                    <!--end::Menu item-->
                    <div class="menu-item px-3">
                        <a href="#" class="menu-link px-3">Souscrire</a>
                    </div>
                </div>
                <!--end::Menu-->
            </div>
        ...
        <div class="topbar d-flex align-items-stretch flex-shrink-0" id="kt_topbar">
            ...
            <div class="d-flex align-items-center ms-2 ms-lg-3">
                <!--begin::Drawer toggle-->
                <div class="btn btn-icon btn-custom w-30px h-30px w-md-40px h-md-40px btn-color-primary" id="kt_contact_toggle">
                    <!--begin::Svg Icon | path: icons/duotune/arrows/arr087.svg-->
                    <span class="svg-icon svg-icon-1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <div class="d-flex align-items-center ms-2 ms-lg-3">
                <!--begin::Drawer toggle-->
                <div class="btn btn-icon btn-custom w-30px h-30px w-md-40px h-md-40px btn-color-primary" id="kt_user_toggle">
