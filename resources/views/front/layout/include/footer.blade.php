                ...
                <div class="col-lg-6 pe-lg-16 mb-10 mb-lg-0">
                    ...
                    <div class="rounded landing-dark-border p-9">
                        ...
                        <span class="fw-normal fs-4 text-gray-700">Use Our Custom Development Service.
									<a href="../../demo16/dist/pages/user-profile/overview.html" class="text-white opacity-50 text-hover-primary">Click to Get a Quote</a></span>
                        <!--end::Text-->
                    </div>
                    <!--end::Block-->
                </div>
                ...
                <div class="col-lg-6 ps-lg-16">
                    ...
                    <div class="d-flex justify-content-center">
                        ...
                        <div class="d-flex fw-bold flex-column me-20">
                            ...
                            <!--end::Link-->
                            <!--begin::Link-->
                            <a href="../../demo16/dist/documentation/getting-started.html" class="text-white opacity-50 text-hover-primary fs-5 mb-6">Documentaions</a>
                            <!--end::Link-->
                            <!--begin::Link-->
                            ...
                            <!--end::Link-->
                            <!--begin::Link-->
                            <a href="../../demo16/dist/documentation/getting-started/changelog.html" class="text-white opacity-50 text-hover-primary fs-5 mb-6">Changelog</a>
                            <!--end::Link-->
                            <!--begin::Link-->
        ...
        <div class="container">
            ...
            <div class="d-flex flex-column flex-md-row flex-stack py-7 py-lg-10">
                ...
                <div class="d-flex align-items-center order-2 order-md-1">
                    <!--begin::Logo-->
                    <a href="../../demo16/dist/landing.html">
