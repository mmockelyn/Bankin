...
@section("content")
    <div class="container">
        <div class="mb-10 w-700px">
            <h1 class="fw-bolder">Bonjour {{ $user->civility->name }} !</h1>
        ...
        <div class="d-flex flex-row justify-content-center align-items-center">
            @if($user->step_open_account == 'STARTING')
                <div class="mb-20">
            ...
            @elseif($user->step_open_account == 'COMPLETED')
            ...
            @elseif($user->step_open_account == 'ACCEPTED')
                ...
                <div class="card shadow-lg mb-10">
                    ...
                    <div class="card-body">
                        <div class="alert alert-dismissible bg-success d-flex flex-column flex-sm-row w-100 p-5 mb-10">
                            ...
                            <!--begin::Content-->
                            <div class="d-flex flex-column text-light pe-0 pe-sm-10">
                                <h4 class="mb-2 text-light">Votre dossier à été accepter, Bienvenue {{ $user->civility->name }} !</h4>
            ...
            @elseif($user->step_open_account == 'DECLINED')
                <div class="mb-20">
                    <div class="d-flex flex-column flex-center">
                        <div class="symbol symbol-100px symbol-circle me-20 mb-5" data-bs-toggle="tooltip" title="Votre offre et votre contrat">
                            <div class="symbol-label bg-light-success">
